...
import { Kit, OrderStructure } from 'src/app/models/order';
import { HelpersService } from '../../services/helpers.service';

@Component({
	selector: 'ntv-order-structure-form',
	templateUrl: './order-structure-form.component.html',
	styleUrls: ['./order-structure-form.component.scss']
})
export class OrderStructureFormComponent implements OnInit {
